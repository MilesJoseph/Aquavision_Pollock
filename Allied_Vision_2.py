...
vimbasrc_factory.set_launch('vimbasrc camera=DEV_1AB22C02DEF0 settingsfile=/home/miles/Aquavision_Pollock/CS_2.xml ! videoconvert ! x264enc speed-preset=ultrafast tune=zerolatency ! rtph264pay name=pay0')
