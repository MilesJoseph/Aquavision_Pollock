...
vimbasrc_factory.set_launch('vimbasrc camera=DEV_1AB22C023E6B settingsfile=/home/miles/AquaVision_Pollock/Aquavision_Pollock/CS_5.xml ! videoconvert ! x264enc speed-preset=ultrafast tune=zerolatency ! rtph264pay name=pay0')
